...
const Features = () => {
	return (
		<section className="flex justify-center text-esim-black-50 bg-night-purple-600 ">
			<div className="flex flex-col text-center gap-20 lg:flex-row lg:flex-wrap lg:justify-center container max-w-screen-2xl">
